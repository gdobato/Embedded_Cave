...
// linker symbol
//=============================================================================
extern unsigned int _INITIAL_STACK_POINTER;
...
{
  (unsigned int)&_INITIAL_STACK_POINTER,     // 0x0000, initial stack pointer
  (unsigned int)&SysStartup_Init,            // 0x0004, reset
  (unsigned int)&undefinedHandler,           // 0x0008, nmi exception
  (unsigned int)&HardFaultHandler,           // 0x000C, hard fault exception
  (unsigned int)&MemManFaultHandler,         // 0x0010, memory management exception
  (unsigned int)&BusFaultHandler,            // 0x0014, bus fault exception
  (unsigned int)&UsageFaultHandler,          // 0x0018, usage fault exception
...
#if 0
void __attribute__((interrupt)) Cat1_Isr(void)
{
