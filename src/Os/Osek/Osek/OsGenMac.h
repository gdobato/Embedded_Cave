...
#define OS_TASK_BEGIN
#define OS_TASK_DEF(Name,Prio,StackSize,NbOfActiv,AutoStart,TaskType,SchedType)  TASK(Name); STACK(Name,StackSize); static Tcb_t Tcb_t_##Name = {pTASK(Name), Prio, AutoStart, TSTACK(Name,StackSize), BSTACK(Name), TSTACK(Name,StackSize), SUSPENDED ,0 ,0 ,0 ,0 , NbOfActiv, TaskType, SchedType};
#define OS_TASK_END
...
#define OS_ALARM_BEGIN
#define OS_ALARM_DEF(Name,Action,Event,task,Callback)                       static Alarm_t Alarm_##Name = {0, 0,  Event,task, Action, ALARM_NO_AUTOSTART, ALARM_FREE, 0, 0, 0, Callback};
#define OS_ALARM_AUTO_DEF(Name,Increment,Cycle,Action,Event,task,Callback)  static Alarm_t Alarm_##Name = {Increment, Cycle,  Event,task, Action, ALARM_AUTOSTART, ALARM_FREE, 0, 0, 0, Callback};
#define OS_ALARM_END
...
#define OS_CONFIG_BEGIN                                                           volatile Ocb_t __attribute__((aligned(4))) OCB_Cfg = {
...
#define OS_CONFIG_END                                                             0,0,INVALID_TASK,0,0,0,0,0};
